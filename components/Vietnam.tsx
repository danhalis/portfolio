...
function Vietnam({ className, height, strokeWidth, strokeColor }: Props) {
  ...
  const mainLandSVGPathPathRef = useRef<SVGPathElement>(null);
  const starSVGPathRef = useRef<SVGPathElement>(null);
  const [islandSVGPathRefs] = useState<React.RefObject<SVGPathElement>[]>([]);

  const islandPathCodes = [
    "M5331 6449 c-14 -5 -37 -7 -53 -4 -21 5 -28 3 -28 -8 0 -26 27 -38 76 -35 51 3 62 14 42 40 -10 12 -19 14 -37 7z",
    "M5750 6375 c0 -19 9 -31 31 -43 66 -36 81 -53 75 -83 -5 -26 -3 -29 19 -29 30 0 58 52 49 93 -9 42 -76 87 -131 87 -39 0 -43 -2 -43 -25z",
    "M6020 6227 c-30 -15 -35 -60 -7 -65 38 -7 62 7 73 43 11 34 10 35 -15 35 -14 0 -37 -6 -51 -13z",
    "M5420 6043 c-37 -7 -73 -40 -87 -81 -7 -20 -13 -41 -13 -46 0 -13 92 0 133 20 34 16 37 21 37 60 0 39 -14 58 -38 53 -4 -1 -18 -4 -32 -6z",
    "M5635 5950 c-4 -6 -4 -24 0 -40 5 -24 12 -30 33 -30 49 0 73 37 43 64 -20 18 -66 21 -76 6z",
    "M5440 5840 c-6 -11 -20 -20 -30 -20 -11 0 -20 -6 -20 -14 0 -8 -3 -21 -6 -30 -5 -13 2 -16 40 -16 26 0 60 7 76 15 25 13 30 22 30 50 0 34 -1 35 -40 35 -29 0 -42 -5 -50 -20z",
    "M6070 5830 c0 -14 -7 -20 -23 -20 -32 0 -61 -32 -45 -48 17 -17 68 -15 74 3 4 9 19 15 40 15 23 0 37 6 44 19 18 34 2 51 -46 51 -37 0 -44 -3 -44 -20z",
    "M5600 5743 c-8 -3 -25 -18 -38 -34 -22 -26 -22 -30 -6 -36 9 -3 29 0 43 8 40 23 41 72 1 62z",
    "M5123 5470 c-26 -10 -32 -54 -10 -63 20 -8 65 3 78 19 9 11 8 19 -6 34 -20 22 -29 23 -62 10z",
    "M7410 1704 c-29 -50 -25 -108 9 -112 28 -4 81 42 81 71 0 21 -18 59 -34 69 -21 14 -34 8 -56 -28z",
    "M7259 1675 c-31 -17 -59 -57 -59 -85 0 -16 6 -20 30 -20 42 0 80 42 80 86 0 37 -10 41 -51 19z",
    "M7538 1534 c-16 -9 -28 -22 -28 -30 0 -18 -71 -94 -87 -94 -7 0 -13 -4 -13 -10 0 -5 -5 -10 -11 -10 -23 0 -88 -61 -82 -77 12 -31 128 5 220 70 44 30 79 101 67 136 -11 31 -29 34 -66 15z",
    "M7120 1394 l0 -37 39 6 c21 2 51 13 66 23 25 17 26 19 9 31 -10 7 -39 13 -66 13 l-48 0 0 -36z",
    "M7323 1187 c-4 -8 -27 -26 -50 -42 -44 -28 -54 -54 -31 -79 20 -21 89 -8 111 21 10 13 25 29 32 37 8 7 15 26 17 42 3 27 0 29 -34 32 -23 2 -39 -2 -45 -11z",
    "M7901 1167 c-20 -20 -12 -37 18 -37 24 0 41 14 41 35 0 9 -51 10 -59 2z",
    "M7340 930 c-14 -4 -40 -8 -58 -9 -25 -1 -37 -8 -52 -33 -26 -43 -23 -94 5 -90 25 5 155 89 155 101 0 5 3 16 6 25 7 18 -13 20 -56 6z",
    "M6785 869 c-5 -5 -29 -23 -52 -39 -44 -31 -56 -60 -26 -60 23 0 80 40 94 68 14 24 2 47 -16 31z",
    "M7821 766 c-14 -17 -2 -77 17 -84 6 -2 19 13 29 33 17 36 17 37 -2 51 -24 18 -30 18 -44 0z",
    "M6734 561 c-67 -17 -74 -41 -11 -41 47 0 84 20 73 38 -8 13 -16 13 -62 3z",
    "M6340 523 c-23 -30 -22 -46 4 -51 53 -11 90 26 60 59 -23 26 -39 24 -64 -8z",
    "M6578 476 c-36 -16 -23 -33 30 -42 42 -7 42 -6 42 25 0 26 -4 31 -22 30 -13 0 -35 -6 -50 -13z",
    "M6162 378 c-7 -7 -12 -18 -12 -25 0 -18 35 -16 51 3 10 13 10 17 -2 25 -19 12 -23 11 -37 -3z",
    "M5982 369 c-37 -14 -21 -34 29 -34 38 0 44 3 47 23 3 18 -1 22 -25 21 -15 0 -39 -4 -51 -10z",
  ];
        ...
        >
          ...
          <motion.path
            ...
            onAnimationComplete={(animation: any) => {
              ...
              // Glow main land
              mainLandSVGPathPathRef.current?.classList.add(
                "2xl:glowing-vietnam-svg"
              );
              // Glow islands
              islandSVGPathRefs.forEach((islandSVGPathRef) => {
                islandSVGPathRef.current?.classList.add(
                  "2xl:glowing-vietnam-svg"
                );
              });
            }}
          ...
          <motion.path
            ...
            onAnimationComplete={(animation: any) => {
              if (animation.pathLength == 0) return;
              starSVGPathRef.current?.classList.add("2xl:glowing-star-svg");
            }}
          />
